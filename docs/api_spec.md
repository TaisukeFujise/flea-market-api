...
| GET | /api/message-rooms | 必要 | DMルーム一覧 |
...
5方向の画像をアップロードし、傷検出を非同期で開始。scan_idを返すので、出品時にPOST /api/productsのリクエストに含める。
...
{
  "images": [
    { "id": "uuid", "url": "https://...", "angle": "front" },
    { "id": "uuid", "url": "https://...", "angle": "back" },
    { "id": "uuid", "url": "https://...", "angle": "right" },
    { "id": "uuid", "url": "https://...", "angle": "left" },
    { "id": "uuid", "url": "https://...", "angle": "top" }
  ],
